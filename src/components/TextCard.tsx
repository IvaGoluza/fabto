...
export default function TextCard({ title, description, price }: TextCardProps) {
  return (
    <div className="w-full sm:w-52 flex flex-col justify-start items-start gap-6 py-4 sm:py-6 sm:p-6 sm:rounded-xl border-2 sm:border border-b-gray-100 sm:border-gray-100 sm:shadow-md">
